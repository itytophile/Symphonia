...
impl AdpcmMsBlockStatus {
    fn read_mono_preamble(stream: &mut BufReader<'_>) -> Result<Self> {
    ...
    fn read_stereo_preamble(stream: &mut BufReader<'_>) -> Result<(Self, Self)> {
